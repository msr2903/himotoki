...
# Import 500 common Japanese sentences from various sources
# (anime, news, TV drama, daily life, business, slang, proverbs, complex grammar)
try:
...
# Flat list for full testing
TEST_SENTENCES = {"common_500": TEST_SENTENCES_500}

# Quick subset for fast testing
QUICK_SENTENCES = QUICK_SENTENCES_50
